	...
	public function getCheckbox($PA, &$fObj)
	{
		...
		if ($confArr['useSelectInsteadCheckbox']) {
			$PA['fieldConf']['config'] = array(
				'type' => 'select',
				'items' => array(
					array('LLL:EXT:imagecycle/locallang_db.xml:tt_content.pi_flexform.from_ts', 2),
					array('LLL:EXT:imagecycle/locallang_db.xml:tt_content.pi_flexform.yes', 1),
					array('LLL:EXT:imagecycle/locallang_db.xml:tt_content.pi_flexform.no', 0),
				),
			);
		} else {
