...
class tx_imagecycle_pi2_wizicon
{
	...
	function proc($wizardItems)
	{
		...
		$wizardItems['plugins_tx_imagecycle_pi2'] = array(
			'icon' => t3lib_extMgm::extRelPath('imagecycle').'pi2/ce_wiz.gif',
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/imagecycle/pi2/class.tx_imagecycle_pi2_wizicon.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/imagecycle/pi2/class.tx_imagecycle_pi2_wizicon.php']);
}
