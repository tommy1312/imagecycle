...
(function ( window, $, undefined ) {
	...
	$.slicebox.defaults 		= {
		...
		showInfo			: false		// Show the info autoamtaically
	};
			...
			setTimeout(function () {
				if ( dir === 'next' ) {
					switch( instance.side ) {
						...
						default : animationStyle = instance.animationStyles.side1;  instance.side = 1; 	break;
					}
				}
				else if ( dir === 'prev' ) {
					switch( instance.side ) {
						...
						default : animationStyle = instance.animationStyles.side3; 	instance.side = 3; 	break;
					}
				}
